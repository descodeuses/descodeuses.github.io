...
<!----------------------------------- ajout section contenu de formation ------------------------------------>
  ...
  </section> <!-- fin section objectifsPedagogiques-->
  ...
  <section id="methode">
    ...
    <ul>
      ...
      <li>La transmission de connaissances par l’équipe pédagogique</li>
  ...
  </section> <!-- fin section approcheCompetence-->
  <section id="evaluations">
    ...
    <p></p>
  </section> <!-- fin section evaluation-->
